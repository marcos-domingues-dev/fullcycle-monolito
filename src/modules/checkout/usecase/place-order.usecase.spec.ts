...
import ProductInvoiceModel from "../../invoice/repository/product.invoice.model";
...
describe("PlaceOrderUseCase unit test", () => {
  ...
  describe("execute method", () => {
    ...
    it("should throw an error when client not found", async () => {
      ...
      const input: PlaceOrderInputDto = { clientId: "0", products: [{ productId: "23" }] };
